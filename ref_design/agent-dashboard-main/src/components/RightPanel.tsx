...
export default function RightPanel({
  ...
  const selectedEvents = events
    .filter((e) => e.agentId === selectedAgentId && e.timestamp <= currentTime)
          ...
          <div className="bg-[#141414] border border-zinc-800/80 rounded-xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[80vh] animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-800/50 bg-[#0f0f0f]">
              ...
              <button
                ...
                className="text-zinc-500 hover:text-zinc-300 transition-colors p-1 hover:bg-zinc-800/50 rounded"
              >
                <X size={16} />
              </button>
            </div>
            <div className="p-6 overflow-y-auto custom-scrollbar space-y-8">
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 mb-4 leading-relaxed">
                  ...
                  persistent context. (e.g. DBA, PM). These agents run continuously throughout the
                  system's lifetime, managing core domains and orchestrating other specialized
                  agents.
                </p>
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 mb-4 leading-relaxed">
                  ...
                  Spawned for specific, short-term tasks. They are archived and their resources are
                  freed immediately upon task completion or when an error occurs.
                </p>
                <div className="flex flex-wrap gap-2">
                  {agents
              ...
              <div>
                ...
                <p className="text-sm text-zinc-400 mb-4 leading-relaxed">
                  ...
                  Agents that exist for the duration of a specific project phase or external
                  contract. They often interact with external environments and are terminated when
                  the phase concludes.
                </p>
                <div className="flex flex-wrap gap-2">
                  {agents
