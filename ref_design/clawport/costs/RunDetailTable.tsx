...
export function RunDetailTable({
  runCosts,
  jobName,
}: {
  runCosts: RunCost[];
  ...
  const sorted = [...runCosts].toSorted((a, b) => b.ts - a.ts);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="hidden-mobile" style={{ width: 120 }}>
          Model
        </span>
        <span style={{ width: 60, textAlign: "right" }}>Input</span>
        <span style={{ width: 60, textAlign: "right" }}>Output</span>
        <span className="hidden-mobile" style={{ width: 60, textAlign: "right" }}>
          Cache
        </span>
