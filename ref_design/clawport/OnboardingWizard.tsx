...
export function OnboardingWizard({ forceOpen, onClose }: OnboardingWizardProps) {
  const { settings, setPortalName, setPortalSubtitle, setOperatorName, setAccentColor } =
    useSettings();
      ...
      fetchOnboarded()
        .then((onboarded) => {
          if (onboarded) {
            ...
            if (localFlag) {
              localStorage.removeItem("clawport-onboarded");
            }
            setVisible(true);
          }
        })
        ...
        >
          ...
          {step === 0 && (
            <div key="step-0" className="animate-fade-in" style={{ textAlign: "center" }}>
              ...
              >
                A visual command centre for your AI agent team. Built to give you direct, real-time
                access to every agent in your OpenClaw workspace.
              </p>
              ...
              >
                {[
                  ...
                  },
                  {
                    emoji: "🎨",
                    title: "Personalize",
                    desc: "Five themes, accent colors, and custom branding",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
            ...
            <div key="step-1" className="animate-fade-in">
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
                ...
                >
                  ...
                  {agentsStatus === "ok" && (
                    <CheckCircle2 size={18} style={{ color: "var(--system-green)" }} />
                  )}
                  {agentsStatus === "error" && (
                    <XCircle size={18} style={{ color: "var(--system-red)" }} />
                  )}
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    {agentsStatus === "ok" && (
                      <div
                        style={{ fontSize: "var(--text-caption1)", color: "var(--text-tertiary)" }}
                      >
              ...
              {agentsStatus === "ok" && agents.length > 0 && (
                <div style={{ marginTop: "var(--space-4)" }}>
                  ...
                  >
                    Does this look like your team? If not, check your{" "}
                    <code
                      style={{
                        fontSize: "var(--text-caption2)",
              ...
              {!systemLoading && !systemAllOk && (
                ...
                >
                  <AlertCircle
                    size={16}
                    style={{ color: "var(--system-red)", flexShrink: 0, marginTop: 2 }}
                  />
                  <div
                    style={{
                      fontSize: "var(--text-caption1)",
                  ...
                  >
                    ...
                    in your terminal to auto-detect and configure your environment. You can continue
                    setup and fix this later.
                  </div>
                </div>
              )}
          ...
          {step === 5 && (
            <div key="step-5" className="animate-fade-in">
              ...
              >
                Talk to your agents using your system&apos;s built-in dictation. No microphone setup
              ...
              >
                ...
                >
                  ...
                  >
                    <div style={{ display: "flex", gap: "var(--space-2)" }}>
                      ...
                      <span>
                        Open <strong>System Settings &gt; Keyboard</strong>
                      </span>
                    </div>
                    <div style={{ display: "flex", gap: "var(--space-2)" }}>
                      <span
                      ...
                      <span>
                        Turn on <strong>Dictation</strong>
                      </span>
                    </div>
                    <div style={{ display: "flex", gap: "var(--space-2)" }}>
                      <span
                      ...
                      <span>
                        Click any chat input, press <strong>Fn Fn</strong> (double-tap), and start
                        talking
                      </span>
                    </div>
                  </div>
                ...
                >
                  ...
                  >
                    Your voice is converted to text by macOS, then sent as a regular message. Agents
                    respond just like they would to typed text. Works in any input field across the
                    app.
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              color:
                step === 1 && systemLoading ? "var(--text-quaternary)" : "var(--accent-contrast)",
              border: "none",
