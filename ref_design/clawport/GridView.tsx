  ...
  return (
    <button
      ...
      style={{
        ...
        border: selected ? `1.5px solid ${agent.color}` : "1px solid var(--separator)",
    ...
    >
      ...
      >
        ...
        >
          ...
          {errorCount > 0 && (
            <span style={{ color: "var(--system-red)", marginLeft: 6 }}>{errorCount} err</span>
          )}
        </span>
      </div>
      {children}
      ...
      {root && (
        <button
          ...
          style={{
            ...
            border:
              selectedId === root.id ? `1.5px solid ${root.color}` : "1px solid var(--separator)",
            cursor: "pointer",
            textAlign: "left",
      ...
      >
        ...
        {soloOps.length > 0 && (
          <TeamSection
            ...
            errorCount={
              crons.filter((c) => soloOps.some((a) => a.id === c.agentId) && c.status === "error")
                .length
            }
          >
            {soloOps.map((a) => (
