...
export function LogBrowser({ entries, summary, loading, filter, onFilterChange }: LogBrowserProps) {
  ...
  if (loading) {
    return (
      <div>
        ...
        >
          {PILLS.map((p) => (
            <Skeleton key={p.key} style={{ width: 64, height: 32, borderRadius: 20 }} />
          ))}
        </div>
        <div
          style={{
          ...
          {[1, 2, 3, 4, 5].map((i) => (
            <div
              ...
              style={{
                ...
                borderBottom: i < 5 ? "1px solid var(--separator)" : undefined,
                gap: "var(--space-3)",
              }}
            >
              <Skeleton
  ...
  const filtered = entries.filter((e) => {
    if (filter === "error" && e.level !== "error") {
      return false;
    }
    if (filter === "cron" && e.source !== "cron") {
      return false;
    }
    if (filter === "config" && e.source !== "config") {
      return false;
    }
              ...
              <div key={entry.id}>
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      width: 8,
                      height: 8,
                      background: LEVEL_DOT[entry.level] ?? "var(--text-tertiary)",
                    }}
                  />
                ...
                {isExpanded && (
                  <div
                    ...
                    style={{ padding: "0 var(--space-4) var(--space-4) var(--space-4)" }}
                  >
                    <div
                      style={{
                        display: "grid",
                    ...
                    >
                      ...
                      <span
                        className="font-mono"
                        style={{ fontSize: "var(--text-caption2)", color: "var(--text-secondary)" }}
                      >
